...
def parse_local_xml(xml_content: str) -> dict:
    ...
    Returns same dict shape as fetch_race_geometry plus:
        ref_twd  – bearing from LG1 to WG1 (TWD reference)
        all_marks – dict of all mark lat/lon
    """
    ...
    # Boundary -> box polygon (use boundary vertices directly)
    box_polygon = [
